...
break
   ...
   if (symbol->getRecognizedMethod() == TR::java_nio_ByteOrder_nativeOrder)
      ...
      if (TR::Compiler->target.cpu.isLittleEndian())
         {
         endianOffset = fej9()->getStaticFieldAddress(classBlock, (unsigned char *)"LITTLE_ENDIAN", 13, (unsigned char *)"Ljava/nio/ByteOrder;", 20);
         endianSymRef = comp()->getSymRefTab()->findOrFabricateStaticSymbol(_methodSymbol, TR::Symbol::Java_nio_ByteOrder_LITTLE_ENDIAN, TR::Address, endianOffset, false, false, true, "java/nio/ByteOrder.LITTLE_ENDIAN", "Ljava/nio/ByteOrder;");
         loadSymbol(TR::aload, endianSymRef);
         }
      else
         {
         endianOffset = fej9()->getStaticFieldAddress(classBlock, (unsigned char *)"BIG_ENDIAN", 10, (unsigned char *)"Ljava/nio/ByteOrder;", 20);
         endianSymRef = comp()->getSymRefTab()->findOrFabricateStaticSymbol(_methodSymbol, TR::Symbol::Java_nio_ByteOrder_BIG_ENDIAN, TR::Address, endianOffset, false, false, true, "java/nio/ByteOrder.BIG_ENDIAN", "Ljava/nio/ByteOrder;");
         loadSymbol(TR::aload, endianSymRef);
         }
      return NULL;
      }
