...
public class Test_JITHelpers {
	...
	public static void test_intrinsicIndexOfUTF16() {
		try {
            ...
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get(""), (int)'\u0190', 0, 0), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get(""), (int)'\u0190', 5, 0), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190"), (int)'\u0190', 0, 1), 0);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190"), (int)'\u0190', 1, 1), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190"), (int)'b', 0, 1), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190"), (int)'b', 1, 1), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190"), (int)'A', 0, 1), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b"), (int)'b', 0, 2), 1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b"), (int)'b', 1, 2), 1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b"), (int)'B', 0, 2), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b"), (int)'B', 1, 2), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b"), (int)'\u0190', 0, 2), 0);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b"), (int)'A', 1, 2), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b"), (int)'\u0190', 1, 2), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b\u0190"), (int)'b', 1, 3), 1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmno"), (int)'o', 0, 15), 14);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmno"), (int)'o', 7, 15), 14);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmno"), (int)'\u0190', 0, 15), 0);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmno"), (int)'x', 0, 15), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmno"), (int)'x', 1, 15), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmno"), (int)'x', 7, 15), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmno"), (int)'d', 0, 15), 3);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmno"), (int)'d', 2, 15), 3);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmno"), (int)'d', 5, 15), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnop"), (int)'o', 0, 16), 14);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnop"), (int)'o', 7, 16), 14);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnop"), (int)'p', 0, 16), 15);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnop"), (int)'p', 5, 16), 15);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnop"), (int)'\u0190', 0, 16), 0);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnop"), (int)'x', 0, 16), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnop"), (int)'x', 1, 16), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnop"), (int)'x', 7, 16), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnop"), (int)'d', 0, 16), 3);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnop"), (int)'d', 2, 16), 3);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnop"), (int)'d', 5, 16), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'o', 0, 17), 14);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'o', 7, 17), 14);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'p', 0, 17), 15);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'p', 5, 17), 15);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'q', 0, 17), 16);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'q', 5, 17), 16);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'\u0190', 0, 17), 0);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'x', 0, 17), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'x', 1, 17), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'x', 7, 17), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'d', 0, 17), 3);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'d', 2, 17), 3);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190bcdefghijklmnopq"), (int)'d', 5, 17), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'o', 0, 31), 28);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'o', 7, 31), 28);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'p', 0, 31), 29);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'p', 5, 31), 29);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'q', 0, 31), 30);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'q', 5, 31), 30);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'\u0190', 0, 31), 0);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'x', 0, 31), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'x', 1, 31), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'x', 7, 31), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'d', 0, 31), 17);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'1', 0, 31), 2);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'1', 1, 31), 2);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'1', 2, 31), 2);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'1', 3, 31), 12);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'1', 4, 31), 12);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'d', 2, 31), 17);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234cdefghijklmnopq"), (int)'d', 5, 31), 17);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'o', 0, 32), 29);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'o', 7, 32), 29);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'p', 0, 32), 30);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'p', 5, 32), 30);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'q', 0, 32), 31);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'q', 5, 32), 31);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'\u0190', 0, 32), 0);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'x', 0, 32), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'x', 1, 32), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'x', 7, 32), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'d', 0, 32), 18);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'d', 2, 32), 18);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b123456789012345cdefghijklmnopq"), (int)'d', 5, 32), 18);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'o', 0, 34), 31);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'o', 7, 34), 31);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'p', 0, 34), 32);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'p', 5, 34), 32);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'q', 0, 34), 33);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'q', 5, 34), 33);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'\u0190', 0, 34), 0);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'x', 0, 34), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'x', 1, 34), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'x', 7, 34), -1);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'d', 0, 34), 20);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'1', 3, 34), 12);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'1', 4, 34), 12);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'1', 0, 34), 2);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'1', 1, 34), 2);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'1', 2, 34), 2);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'6', 3, 34), 7);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'6', 8, 34), 17);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'d', 2, 34), 20);
            Assert.assertEquals(helpers.intrinsicIndexOfUTF16(valueField.get("\u0190b12345678901234567cdefghijklmnopq"), (int)'d', 5, 34), 20);
		} catch (IllegalAccessException e) {
			throw new RuntimeException(e);
		} catch (NoSuchFieldException e) {
			throw new RuntimeException(e);
