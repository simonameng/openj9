...
public class TestJavaLangMath {
    ...
    /*
    * The following test is for testing the java_lang_Math_sqrt function. 
    ...
    */
    ...
    public void test_java_lang_Math_sqrt() {
        ...
        AssertJUnit.assertTrue(Double.isNaN(Math.sqrt((double)-42.25)));
        AssertJUnit.assertEquals(-0.0, Math.sqrt((double)-0.0));
        AssertJUnit.assertEquals(+0.0, Math.sqrt((double)+0.0));
        AssertJUnit.assertEquals(7.5, Math.sqrt((double)56.25));
